        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.chongwuPhoto" label="宠物图片" prop="chongwuPhoto">
                        <file-upload
                            tip="点击上传宠物图片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.chongwuPhoto" label="宠物图片" prop="chongwuPhoto">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="宠物详情" prop="replyContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.replyContent" label="宠物详情" prop="replyContent">
